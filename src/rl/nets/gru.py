...
class GRU(nn.Module):
    ...
    Args:
        ...
        hidden_dim: dimension of the GRU hidden state (default 128).
    ...
    Notes on shape conventions:
        ...
        - State convention: GRU has a single hidden tensor ``h`` (not a tuple).
    ...
    def forward(self, obs, state=None):
        ...
        out, new_state = self.gru(obs, state)  # out: (batch, seq, hidden)
