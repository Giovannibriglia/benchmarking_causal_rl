"""LEGACY cell-exposure table - test fixtures ONLY.

This is the recovered pre-paper exposure config (z/u observability switches)
used by the analytic fixture envs to shape their observations. It is NOT the
paper taxonomy - that lives in src/causal/cells.py.
"""
